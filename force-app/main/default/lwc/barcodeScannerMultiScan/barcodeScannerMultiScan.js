...
// import mtrlogo from '@salesforce/resourceUrl/mtrlogo';
...
export default class BarcodeScannerExample extends LightningElement {
    ...
    handleBeginScanClick(event) {
        ...
        // Code_128 is according to Google Gemini the equired Code Type for Metro Card
        if (this.myScanner != null && this.myScanner.isAvailable()) {
            const scanningOptions = {
                barcodeTypes: [this.myScanner.barcodeTypes.QR,
                                this.myScanner.barcodeTypes.CODE_128
                ],
                instructionText: 'Scan a Card Code',
            ...
            this.myScanner
                ...
                .then((result) => {
                    ...
                    this.dispatchEvent(
                        new ShowToastEvent({
                            ...
                            message: 'Card Code scanned successfully.',
                            variant: 'success'
                        })
                    );
                })
                .catch((error) => {
                    ...
                    if (error.code == 'USER_DISMISSED') {
                        ...
                        this.dispatchEvent(
                            new ShowToastEvent({
                                title: 'Card Code Scanner Error',
                                message:
                                    'There was a problem scanning the card code: ' +
                                    error.message,
                                variant: 'error',
                                mode: 'sticky'
                            })
            ...
            console.log(
                'Scan cardcode button should be disabled and unclickable.'
            );
            ...
            this.dispatchEvent(
                new ShowToastEvent({
                    title: 'Card code Scanner Is Not Available',
                    message:
